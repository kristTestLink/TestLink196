...
public function getTestCase($args)
{
   ...
   * @param struct $args
   * @param string $args["devKey"]
   * @param int $args["user"] user id
   *
   * @return String user name
   *
   * @access public
   */
  public function getUserNameById($args)
  {
    $this->_setArgs($args);
    $user_name = tlUser::getById($this->dbObj,$this->args[self::$userParamName]);
...
protected function createAttachmentTempFile()
{
  ...
  function initMethodYellowPages()
  {
    $this->methods = array( 'tl.reportTCResult' => 'this:reportTCResult',
                            ...
                            'tl.getUserNameById' => 'this:getUserNameById',
